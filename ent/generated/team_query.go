...
func (tq *TeamQuery) QueryAccount() *AccountQuery {
...
func (tq *TeamQuery) WithAccount(opts ...func(*AccountQuery)) *TeamQuery {
	query := (&AccountClient{config: tq.config}).Query()
...
func (tq *TeamQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Team, error) {
	...
	if query := tq.withAccount; query != nil {
		if err := tq.loadAccount(ctx, query, nodes, nil,
			func(n *Team, e *Account) { n.Edges.Account = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (tq *TeamQuery) loadAccount(ctx context.Context, query *AccountQuery, nodes []*Team, init func(*Team), assign func(*Team, *Account)) error {
...
func (tq *TeamQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := tq.ctx.Fields; len(fields) > 0 {
		...
		if tq.withAccount != nil {
			_spec.Node.AddColumnOnce(team.FieldAccountID)
		}
	}
