...
func (au *AccountUpdate) AddMilestoneIDs(ids ...int) *AccountUpdate {
	au.mutation.AddMilestoneIDs(ids...)
	return au
}

// AddMilestones adds the "milestones" edges to the Milestone entity.
func (au *AccountUpdate) AddMilestones(m ...*Milestone) *AccountUpdate {
	ids := make([]int, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
	return au.AddMilestoneIDs(ids...)
}

// AddIssueIDs adds the "issues" edge to the Issue entity by IDs.
func (au *AccountUpdate) AddIssueIDs(ids ...int) *AccountUpdate {
	au.mutation.AddIssueIDs(ids...)
	return au
}

// AddIssues adds the "issues" edges to the Issue entity.
func (au *AccountUpdate) AddIssues(i ...*Issue) *AccountUpdate {
	ids := make([]int, len(i))
	for j := range i {
		ids[j] = i[j].ID
	}
...
func (au *AccountUpdate) ClearMilestones() *AccountUpdate {
	au.mutation.ClearMilestones()
	return au
}

// RemoveMilestoneIDs removes the "milestones" edge to Milestone entities by IDs.
func (au *AccountUpdate) RemoveMilestoneIDs(ids ...int) *AccountUpdate {
	au.mutation.RemoveMilestoneIDs(ids...)
	return au
}

// RemoveMilestones removes "milestones" edges to Milestone entities.
func (au *AccountUpdate) RemoveMilestones(m ...*Milestone) *AccountUpdate {
	ids := make([]int, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
	return au.RemoveMilestoneIDs(ids...)
}

// ClearIssues clears all "issues" edges to the Issue entity.
func (au *AccountUpdate) ClearIssues() *AccountUpdate {
	au.mutation.ClearIssues()
	return au
}

// RemoveIssueIDs removes the "issues" edge to Issue entities by IDs.
func (au *AccountUpdate) RemoveIssueIDs(ids ...int) *AccountUpdate {
	au.mutation.RemoveIssueIDs(ids...)
	return au
}

// RemoveIssues removes "issues" edges to Issue entities.
func (au *AccountUpdate) RemoveIssues(i ...*Issue) *AccountUpdate {
	ids := make([]int, len(i))
	for j := range i {
		ids[j] = i[j].ID
	}
...
func (au *AccountUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if au.mutation.MilestonesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := au.mutation.RemovedMilestonesIDs(); len(nodes) > 0 && !au.mutation.MilestonesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   account.MilestonesTable,
	...
	if nodes := au.mutation.MilestonesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   account.MilestonesTable,
	...
	if nodes := au.mutation.RemovedIssuesIDs(); len(nodes) > 0 && !au.mutation.IssuesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   account.IssuesTable,
	...
	if nodes := au.mutation.IssuesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   account.IssuesTable,
...
// AddMilestoneIDs adds the "milestones" edge to the Milestone entity by IDs.
func (auo *AccountUpdateOne) AddMilestoneIDs(ids ...int) *AccountUpdateOne {
	auo.mutation.AddMilestoneIDs(ids...)
	return auo
}

// AddMilestones adds the "milestones" edges to the Milestone entity.
func (auo *AccountUpdateOne) AddMilestones(m ...*Milestone) *AccountUpdateOne {
	ids := make([]int, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
	return auo.AddMilestoneIDs(ids...)
}

// AddIssueIDs adds the "issues" edge to the Issue entity by IDs.
func (auo *AccountUpdateOne) AddIssueIDs(ids ...int) *AccountUpdateOne {
	auo.mutation.AddIssueIDs(ids...)
	return auo
}

// AddIssues adds the "issues" edges to the Issue entity.
func (auo *AccountUpdateOne) AddIssues(i ...*Issue) *AccountUpdateOne {
	ids := make([]int, len(i))
	for j := range i {
		ids[j] = i[j].ID
	}
...
// ClearMilestones clears all "milestones" edges to the Milestone entity.
func (auo *AccountUpdateOne) ClearMilestones() *AccountUpdateOne {
	auo.mutation.ClearMilestones()
	return auo
}

// RemoveMilestoneIDs removes the "milestones" edge to Milestone entities by IDs.
func (auo *AccountUpdateOne) RemoveMilestoneIDs(ids ...int) *AccountUpdateOne {
	auo.mutation.RemoveMilestoneIDs(ids...)
	return auo
}

// RemoveMilestones removes "milestones" edges to Milestone entities.
func (auo *AccountUpdateOne) RemoveMilestones(m ...*Milestone) *AccountUpdateOne {
	ids := make([]int, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
	return auo.RemoveMilestoneIDs(ids...)
}

// ClearIssues clears all "issues" edges to the Issue entity.
func (auo *AccountUpdateOne) ClearIssues() *AccountUpdateOne {
	auo.mutation.ClearIssues()
	return auo
}

// RemoveIssueIDs removes the "issues" edge to Issue entities by IDs.
func (auo *AccountUpdateOne) RemoveIssueIDs(ids ...int) *AccountUpdateOne {
	auo.mutation.RemoveIssueIDs(ids...)
	return auo
}

// RemoveIssues removes "issues" edges to Issue entities.
func (auo *AccountUpdateOne) RemoveIssues(i ...*Issue) *AccountUpdateOne {
	ids := make([]int, len(i))
	for j := range i {
		ids[j] = i[j].ID
	}
...
func (auo *AccountUpdateOne) sqlSave(ctx context.Context) (_node *Account, err error) {
	...
	if auo.mutation.MilestonesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   account.MilestonesTable,
	...
	if nodes := auo.mutation.RemovedMilestonesIDs(); len(nodes) > 0 && !auo.mutation.MilestonesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   account.MilestonesTable,
	...
	if nodes := auo.mutation.MilestonesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   account.MilestonesTable,
	...
	if nodes := auo.mutation.RemovedIssuesIDs(); len(nodes) > 0 && !auo.mutation.IssuesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   account.IssuesTable,
	...
	if nodes := auo.mutation.IssuesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   account.IssuesTable,
