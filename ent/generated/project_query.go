...
func (pq *ProjectQuery) QueryAccount() *AccountQuery {
...
func (pq *ProjectQuery) WithAccount(opts ...func(*AccountQuery)) *ProjectQuery {
	query := (&AccountClient{config: pq.config}).Query()
...
func (pq *ProjectQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Project, error) {
	...
	if query := pq.withAccount; query != nil {
		if err := pq.loadAccount(ctx, query, nodes, nil,
			func(n *Project, e *Account) { n.Edges.Account = e }); err != nil {
			return nil, err
		}
	}
...
func (pq *ProjectQuery) loadAccount(ctx context.Context, query *AccountQuery, nodes []*Project, init func(*Project), assign func(*Project, *Account)) error {
